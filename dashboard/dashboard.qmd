...
format: 
  dashboard:
    # nav-buttons: [github]
    # github: https://github.com/lillyspeier/lillyspeier.github.io
logo: images/body_scan
theme: [sandstone, theme/custom.scss]
fig-width: 10
fig-asp: 0.3
params:
  year: "2017-2020"
  # link: https://wwwn.cdc.gov/nchs/nhanes/continuousnhanes/default.aspx?Cycle=2017-2020
...
This data includes 3383 subjects who are children between the ages of 2 and 17 years old, filtered from the National Health and Nutrition Examination Survey (NHANES) results, [which are publicly available here](https://www.cdc.gov/nchs/data/nvsr/nvsr72/nvsr72-01.pdf).
